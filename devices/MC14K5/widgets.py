...
# this is not really a nice way to import it as ui is mostely for testing
# in the future figure out where Indicator and the like widgets go maybe under devices and widgets?
from interface.ui import Indicator
